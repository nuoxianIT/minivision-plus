 ...
 * the License.
 */
package com.minivision.plus.generator.config.po;
            ...
            for (TableField field : fields) {
                ...
                if (field.isKeyFlag()) {
                    ...
                    if (field.isConvert() || field.isKeyIdentityFlag()) {
                        importPackages.add(com.minivision.plus.annotation.TableId.class.getCanonicalName());
                    }
                    // 自增
                    if (field.isKeyIdentityFlag()) {
                        importPackages.add(com.minivision.plus.annotation.IdType.class.getCanonicalName());
                    }
                } else if (field.isConvert()) {
                    // 普通字段
                    importPackages.add(com.minivision.plus.annotation.TableField.class.getCanonicalName());
                }
                if (null != field.getFill()) {
                    // 填充字段
                    importPackages.add(com.minivision.plus.annotation.TableField.class.getCanonicalName());
                    importPackages.add(com.minivision.plus.annotation.FieldFill.class.getCanonicalName());
                }
            }
        }
        return this;
